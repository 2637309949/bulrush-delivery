module github.com/2637309949/bulrush-delivery
...
replace golang.org/x/image v0.0.0-20190523035834-f03afa92d3ff => github.com/golang/image v0.0.0-20190523035834-f03afa92d3ff
